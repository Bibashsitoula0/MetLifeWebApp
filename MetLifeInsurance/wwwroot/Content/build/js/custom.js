...
var DashBoardJS = function () {
    ...
    function init_charts() {
        ...
        self.PaymentStatus = function (paymentstatus) {
            ...
            if ($('#canvasDoughnut').length) {
                ...
                var paymentCount = paymentstatus.map(function (item) {
                    return item.count;
                });
                var paymentStatus = paymentstatus.map(function (item) {
                    return item.payment_status;
                });
                var paymentColor = paymentstatus.map(function (item) {
                    return item.color;
                });
            ...
            if ($('#pieChart').length) {
                ...
                var booking = {
                    ...
                    datasets: [{
                        ...
                        label: bookingLabels // for legend
                    }],
                ...
                var pieChart = new Chart(ctx, {
                    ...
                    otpions: {
                        ...
                        text: 'Chart.js - Hide/Show Legend From Button Click'
                    }
                });
        ...
        self.DoctorDrawPieChart = function (bookingcount) {
            ...
            if ($('#doctorbookingstatus').length) {
                ...
                var bookingsdoctorcolor = bookingcount.map(function (item) {
                    return item.color;
                });
                console.log("bookingLevels", bookingLabels);
                ...
                var booking = {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: bookingsdoctorcolor,
                        label: 'Booking Count' // for legend
                    }],
                    labels: bookingLabels
        ...
        self.DoctorPaymentStatus = function (paymentstatus) {
                ...
                if ($('#DoctordonotpaymentStatus').length) {
                    ...
                    var ctx = document.getElementById("DoctordonotpaymentStatus");
                    var data = {
                        labels: paymentStatus,
                        datasets: [{
                            data: paymentCount,
        ...
        self.MedicalStatus = function (medicalstatus) {
            if ($('#medicalpieChart').length) {
                var ctx = document.getElementById("medicalpieChart");

                var medicalcount = medicalstatus.map(function (item) {
                    return item.medical_institute_count;
                });
                var medicalwisestatus = medicalstatus.map(function (item) {
                    return item.medical_institute;
                });

                var medicalwisecolor = medicalstatus.map(function (item) {
                    return item.color;
                });

                console.log("helloppp", ctx);
                var data = {
                    datasets: [{
                        data: medicalcount,
                        backgroundColor: medicalwisecolor,
                        label: 'My dataset' // for legend
                    }],
                    labels: medicalwisestatus
                };
                var pieChart = new Chart(ctx, {
                    data: data,
                    type: 'pie',
        ...
        self.DoctorMedicalStatus = function (medicalstatus) {
            if ($('#doctormedicalpieChart').length) {
                var ctx = document.getElementById("doctormedicalpieChart");
       ...
       /* self.DoctorNameStatus = function (doctorname) {
            if ($('#doctornamewise').length) {
                var ctx = document.getElementById("doctornamewise");
    ...
    function init_echarts() {
        ...
        //echart Bar
        self.ReportTestWise = function (paymentstatus) {
            ...
            if ($('#mainb').length) {
                ...
                var testcounts = paymentstatus.map(function (item) {
                    return item.testwisecount;
                });

              

                var testLabels = paymentstatus.map(function (item) {
                    return item.test;
                });
        ...
        self.DoctorNameStatus = function (doctorname) {
            ...
            if ($('#doctorb').length) {
                ...
                var echartBar = echarts.init(document.getElementById('doctorb'), theme);
        ...
        self.TeleDoctorNameStatus = function (doctorname) {
            console.log("doctorname", doctorname);
            if ($('#teledoctorb').length) {

                var echartBar = echarts.init(document.getElementById('teledoctorb'), theme);
     ...
     /*   self.DrawPieChart = function (bookingcount) {
        ...
        self.PaymentStatus = function (paymentcount) {
            ...
            if ($('#echart_donut_payment_booking').length) {
                ...
                var echartDonut = echarts.init(document.getElementById('echart_donut_payment_booking'), theme);
        ...
        self.DoctorPaymentStatus = function (paymentcount) {
            ...
            if ($('#echart_donut_physical').length) {
                ...
                var echartDonut = echarts.init(document.getElementById('echart_donut_physical'), theme);
        ...
        self.MedicalStatus = function (medicalinstitute) {
            ...
            if ($('#medicalpieChart').length) {
                ...
                var echartPie = echarts.init(document.getElementById('medicalpieChart'), theme);
        ...
        self.DoctorMedicalStatus = function (medicalinstitute) {
            ...
            if ($('#echart_pie_physical_institute').length) {

                var echartPie = echarts.init(document.getElementById('echart_pie_physical_institute'), theme);
        ...
        self.DrawPieChart = function (bookingcount) {
            ...
            if ($('#echart_pie_booking').length) {

                var echartPie = echarts.init(document.getElementById('echart_pie_booking'), theme);
        ...
        self.DoctorDrawPieChart = function (bookingcount) {
            ...
            if ($('#echart_pie_physical').length) {

                var echartPie = echarts.init(document.getElementById('echart_pie_physical'), theme);
